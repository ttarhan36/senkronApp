...
const CATEGORIES = ['TÜM OKUL', 'HAZIRLIK', '9. SINIFLAR', '10. SINIFLAR', '11. SINIFLAR', '12. SINIFLAR', 'MEZUNLAR', 'PERSONEL'];
...
const CoursesModule: React.FC<CoursesModuleProps> = ({
   ...
   const [formData, setFormData] = useState<Partial<Course>>({
      name: '', teacherName: '', capacity: 20, schedule: '', category: 'TÜM OKUL', targetGrades: []
   });
