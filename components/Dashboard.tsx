   ...
   return (
      <div className="bg-[#0d141b]/90 border border-[#354a5f]/40 p-5 relative overflow-hidden bg-grid-hatched shadow-2xl rounded-sm">
         <div className="flex items-center justify-between mb-4">
            <div>
               <h3 className="text-[13px] font-normal text-white uppercase tracking-[0.3em] leading-none">AI TELAFİ MOTORU</h3>
               <p className="text-[7px] font-normal text-slate-500 uppercase mt-1.5 tracking-widest">RİSK HARİTASI · SON DENEME ANALİZİ</p>
            </div>
            <div className="flex items-center gap-3">
               {redCount > 0 && (
                  <span className="flex items-center gap-1.5 bg-red-500/10 border border-red-500/20 px-2 py-1 rounded">
                     <span className="w-2 h-2 rounded-full bg-red-500 animate-pulse" />
                     <span className="text-[9px] font-normal text-red-400 uppercase">{redCount} ACİL</span>
                  </span>
               )}
               <button
                  onClick={() => setActiveModule(ModuleType.STUDENT_EXAMS)}
                  className="min-h-[44px] px-4 py-1.5 bg-[#3b82f6]/10 border border-[#3b82f6]/30 text-[#3b82f6] text-[9px] font-normal uppercase tracking-widest hover:bg-[#3b82f6] hover:text-white transition-all"
               >
                  SINAVLAR
               </button>
            </div>
               ...
               return (
                  <div key={alert.objectiveId} className={`flex items-center gap-3 p-3 rounded-sm border ${c.bg}`}>
                     ...
                     <div className="flex-1 min-w-0">
                        <p className={`text-[10px] font-normal ${c.text} uppercase truncate`}>{alert.subject}</p>
            ...
            <div className="bg-[#0f172a] border-2 border-[#3b82f6]/40 p-3 rounded-sm shadow-2xl relative overflow-hidden flex items-center justify-between bg-grid-hatched shrink-0 mb-3">
               <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col min-w-0 pr-2">
                     <h2 className="text-[15px] font-normal text-white uppercase tracking-widest leading-none truncate" title={student.name}>{student.name}</h2>
                     <div className="flex items-center gap-3 mt-1.5">
                        <span className="px-2 py-0.5 bg-[#fbbf24]/10 border border-[#fbbf24]/20 text-[#fbbf24] text-[8px] font-normal uppercase tracking-widest">NO: {student.number}</span>
                        <span className="text-[8px] font-normal text-[#3b82f6] uppercase tracking-[0.2em]">{studentClass.name} ŞUBESİ</span>
                     </div>
                  </div>
               </div>
            </div>
                  ...
                  <div className="space-y-4 animate-in slide-in-from-bottom-2 pb-12">
                        ...
                        <div className="bg-gradient-to-br from-indigo-900/40 to-blue-900/40 border border-blue-500/30 p-4 rounded-sm shadow-xl relative overflow-hidden group">
                           ...
                           <div className="flex items-center justify-between z-10 relative gap-3">
                              <div className="flex items-center gap-2 md:gap-4 flex-1 min-w-0">
                                 ...
                                 <div className="flex-1 min-w-0">
                                    <h4 className="text-[10px] md:text-[12px] font-normal text-white uppercase tracking-widest leading-none truncate block w-full">LGS HEDEFİNE ODAKLAN</h4>
                                    <p className="text-[7px] md:text-[9px] font-normal text-blue-200/60 uppercase mt-0.5 md:mt-1 tracking-widest truncate block w-full">{goals.targetSchool || 'HAYALİNDEKİ LİSE İÇİN ÇALIŞMAYA DEVAM ET'}</p>
                                 </div>
                              </div>
                              <div className="flex flex-col items-end shrink-0 pl-2">
                                 <span className="text-[20px] md:text-[28px] font-normal text-white leading-none">{getLGSDaysLeft()}</span>
                                 <span className="text-[6px] md:text-[8px] font-normal text-blue-400 uppercase tracking-widest">GÜN KALDI</span>
                              </div>
                           </div>
                        </div>
                     )}
                        ...
                        <div className="bg-gradient-to-br from-purple-900/40 to-pink-900/40 border border-purple-500/30 p-4 rounded-sm shadow-xl relative overflow-hidden group">
                           ...
                           <div className="flex items-center justify-between z-10 relative gap-3">
                              <div className="flex items-center gap-2 md:gap-4 flex-1 min-w-0">
                                 ...
                                 <div className="flex-1 min-w-0">
                                    <h4 className="text-[10px] md:text-[12px] font-normal text-white uppercase tracking-widest leading-none truncate block w-full">YKS YOLCULUĞU</h4>
                                    <p className="text-[7px] md:text-[9px] font-normal text-purple-200/60 uppercase mt-0.5 md:mt-1 tracking-widest truncate block w-full">{goals.targetSchool || 'ÜNİVERSİTE HEDEFİN İÇİN TEMPOYU ARTIR'}</p>
                                 </div>
                              </div>
                              <div className="flex items-center gap-2 shrink-0 pl-2">
                                 <div className="px-2 md:px-3 py-1 bg-purple-500/20 border border-purple-500/30 rounded-sm">
                                    <span className="text-[8px] md:text-[10px] font-normal text-white uppercase">TYT/AYT</span>
                                 </div>
                              </div>
                           </div>
                        </div>
                     ...
                     <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        <div className="bg-slate-900/60 border border-white/5 p-4 shadow-xl relative overflow-hidden rounded-sm">
                           <span className="text-[10px] font-normal text-[#3b82f6] uppercase tracking-[0.4em] block mb-3">VELİ_DNA_VE_İLETİŞİM</span>
                           <div className="space-y-3">
                              <div>
                                 <label className="text-[7px] font-normal text-slate-500 uppercase tracking-widest block mb-0.5">VELİ ADI SOYADI</label>
                                 <span className="text-[12px] font-normal text-white uppercase">{student.parentName || 'BELİRTİLMEDİ'}</span>
                              </div>
                              <div className="flex justify-between items-center bg-black/40 p-2.5 border border-white/5">
                                 <div className="flex-1">
                                    <label className="text-[7px] font-normal text-slate-500 uppercase tracking-widest block mb-0.5">TELEFON_HABERLEŞME</label>
                                    <span className="text-[13px] font-normal text-[#fbbf24] tracking-widest">{student.parentPhone || 'KAYITSIZ'}</span>
                                 </div>
                        ...
                        <div className="bg-slate-900/60 border border-white/5 p-4 shadow-xl relative overflow-hidden rounded-sm flex flex-col h-[140px]">
                           <span className="text-[10px] font-normal text-slate-500 uppercase tracking-[0.4em] block mb-3">KANAAT_VE_GÖZLEM_DNA</span>
                           <div className="flex-1 overflow-y-auto no-scrollbar space-y-2">
                              {(student.observations && student.observations.length > 0) ? student.observations.slice().reverse().map(obs => (
                                 <div key={obs.id} className="bg-black/20 p-2 border-l-2 border-[#3b82f6]">
                                    <p className="text-[10px] font-normal text-white italic">"{obs.content}"</p>
                                    <div className="flex justify-between mt-1"><span className="text-[7px] font-normal text-[#3b82f6]">{obs.teacherName}</span><span className="text-[6px] text-slate-600">{obs.date}</span></div>
                                 </div>
                              )) : (
                        ...
                        <div className="bg-slate-900/60 border border-white/5 p-4 shadow-xl relative overflow-hidden rounded-sm group hover:border-[#3b82f6]/40 transition-all">
                           <div className="flex items-center justify-between mb-4">
                              <span className="text-[10px] font-normal text-[#3b82f6] uppercase tracking-[0.4em]">HESAP_KİMLİK_BİLGİLERİ</span>
                              <span className="text-[7px] font-normal text-green-500 uppercase tracking-widest animate-pulse">DÜZENLEME AKTİF</span>
                           </div>
                           <div className="space-y-3">
                              <div className="grid grid-cols-2 gap-2">
                                 <div className="flex flex-col gap-1">
                                    ...
                                    <input
                                       className="bg-black border border-white/10 p-2 text-[11px] font-normal text-white outline-none focus:border-[#3b82f6] transition-all uppercase"
                              ...
                              <div className="mt-2 space-y-3">
                                 ...
                                 {(studentClass.grade === 8 || studentClass.grade >= 11) && (
                                    <div className="grid grid-cols-2 gap-2 border-t border-white/5 pt-3 mt-1">
                                       <div className="flex flex-col gap-1">
                                          <span className="text-[8px] font-normal text-slate-500 uppercase ml-1">{studentClass.grade === 8 ? 'HEDEF LİSE' : 'HEDEF ÜNİVERSİTE'}</span>
                                          <input
                                             className="bg-black border border-white/10 p-2 text-[11px] font-normal text-indigo-400 outline-none focus:border-indigo-500 transition-all uppercase"
                                             placeholder="..."
                                       ...
                                       <div className="flex flex-col gap-1">
                                          <span className="text-[8px] font-normal text-slate-500 uppercase ml-1">PUAN HEDEFİ</span>
                                          <input
                                             type="number"
                                             className="bg-black border border-white/10 p-2 text-[11px] font-normal text-emerald-400 outline-none focus:border-emerald-500 transition-all"
                                             placeholder="500"
                                 ...
                                 <button onClick={handleUpdateStudentCredentials} className="w-full h-10 bg-[#3b82f6] text-white font-normal text-[10px] uppercase tracking-widest hover:brightness-110 active:scale-95 transition-all shadow-lg">BİLGİLERİ GÜNCELLEN VE KAYDET</button>
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div className="grid grid-cols-2 lg:grid-cols-4 gap-2">
                        <div className="bg-black/60 border border-white/10 p-5 flex flex-col items-center justify-center group hover:bg-slate-800/40 transition-all shadow-xl rounded-sm">
                           <span className="text-[28px] font-normal text-[#fbbf24] leading-none">{computedGPA}</span>
                           <span className="text-[7px] font-normal text-slate-500 uppercase tracking-widest mt-2">GENEL_ORTALAMA</span>
                        </div>
                        <div className="bg-black/60 border border-white/10 p-5 flex flex-col items-center justify-center group hover:bg-slate-800/40 transition-all shadow-xl rounded-sm">
                           <span className="text-[28px] font-normal text-white leading-none">{student.attendanceCount || '0'}</span>
                           <span className="text-[7px] font-normal text-slate-500 uppercase tracking-widest mt-2">DEVAMSIZLIK</span>
                        </div>
                        <div className="bg-black/60 border border-white/10 p-5 flex flex-col items-center justify-center group hover:bg-slate-800/40 transition-all shadow-xl rounded-sm">
                           <span className="text-[28px] font-normal text-[#3b82f6] leading-none">{socialHours} s</span>
                           <span className="text-[7px] font-normal text-slate-500 uppercase tracking-widest mt-2">SOSYAL_GÖREV (S)</span>
                        </div>
                        <div className="bg-black/60 border border-white/10 p-5 flex flex-col items-center justify-center group hover:bg-slate-800/40 transition-all shadow-xl rounded-sm">
                           <span className="text-[24px] font-normal text-green-500 leading-none">%{Math.round((parseFloat(computedGPA) / 100) * 85 + 15)}</span>
                           <span className="text-[7px] font-normal text-slate-500 uppercase tracking-widest mt-2">AKADEMİK_TREND</span>
                        </div>
                     </div>
                  </div>
               )}
                  ...
                  <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-300">
                     ...
                     <div className="flex flex-col">
                        <div className="flex items-center gap-2 mb-4">
                           ...
                           <h3 className="text-[10px] font-normal text-[#fcd34d] uppercase tracking-[0.4em]">YAKLAŞAN SINAVLARIM</h3>
                        </div>
                           ...
                           {studentUpcomingExams.length > 0 ? studentUpcomingExams.map(exam => {
                              ...
                              return (
                                 <div key={exam.id} className={`p-4 border-l-4 bg-[#1e293b] border-white/5 rounded-r-sm shadow-lg flex items-center justify-between group hover:brightness-110 transition-all ${isCritical ? 'border-l-red-500' : isNear ? 'border-l-orange-500' : 'border-l-green-500'}`}>
                                    <div>
                                       <span className="text-[14px] font-normal text-white uppercase tracking-tight block">{exam.lessonName}</span>
                                       <span className="text-[9px] font-normal text-slate-400 uppercase tracking-widest mt-1 block">{exam.displayDate}</span>
                                       <span className="text-[6px] font-normal text-[#3b82f6] uppercase bg-[#3b82f6]/10 px-1.5 py-0.5 rounded-sm mt-2 inline-block border border-[#3b82f6]/20">{exam.slot.toUpperCase().replace('EXAM', '')}. YAZILI</span>
                                    </div>
                                    <div className={`flex flex-col items-center justify-center w-16 h-16 rounded-full border-2 ${colorClass} ${bgClass}`}>
                                       <span className="text-[18px] font-normal leading-none">{exam.daysLeft}</span>
                                       <span className="text-[6px] font-normal uppercase">GÜN</span>
                                    </div>
                                 </div>
                              );
                           }) : (
                              <div className="col-span-full py-8 text-center opacity-30 border border-dashed border-white/10 rounded-sm bg-black/20">
                                 ...
                                 <p className="text-[9px] font-normal uppercase tracking-[0.3em]">YAKINDA SINAV YOK</p>
                              </div>
                           )}
                        </div>
                     </div>
                  ...
                  <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-300">
                     ...
                     <div className="flex flex-col">
                        <div className="flex items-center gap-2 mb-4">
                           ...
                           <h3 className="text-[10px] font-normal text-[#3b82f6] uppercase tracking-[0.4em]">SON İŞLENEN KONULAR VE ÖDEVLER</h3>
                        </div>
                        <div className="space-y-3">
                           {studentRecentLogs.length > 0 ? studentRecentLogs.map(log => (
                                 ...
                                 <div className="flex justify-between items-start mb-3 border-b border-white/5 pb-2">
                                    <div className="flex flex-col min-w-0">
                                       <div className="flex items-center gap-2">
                                          ...
                                          <span className="text-[11px] font-normal text-white/80 uppercase tracking-tight truncate" title={log.displayLesson}>{log.displayLesson}</span>
                                       </div>
                                       <span className="text-[8px] font-normal text-slate-500 uppercase tracking-widest mt-1 ml-3 truncate">{log.displayTeacher}</span>
                                    </div>
                                    <div className="flex flex-col items-end">
                                       <span className="text-[10px] font-normal text-[#fbbf24] bg-[#fbbf24]/10 px-2 py-0.5 border border-[#fbbf24]/20 rounded-sm">{log.date}</span>
                                       <span className="text-[6px] font-normal text-slate-500 uppercase mt-1 tracking-widest">{log.hour}. DERS</span>
                                    </div>
                                 </div>
                                 <div className="space-y-3 pl-3">
                                    <div>
                                       <span className="text-[7px] font-normal text-[#3b82f6] uppercase tracking-widest block mb-1">İŞLENEN KONU</span>
                                       <p className="text-[11px] font-normal text-slate-300 leading-snug">{log.subject}</p>
                                    </div>
                                    {log.homework && (
                                       <div className="bg-black/20 p-2 border-l-2 border-amber-600/50">
                                          <span className="text-[7px] font-normal text-amber-500 uppercase tracking-widest block mb-1">ÖDEV / PROJE</span>
                                          <p className="text-[11px] font-normal text-white leading-snug">{log.homework}</p>
                                       </div>
                                    )}
                                 </div>
                              </div>
                              ...
                              <div className="py-12 text-center opacity-30 border-2 border-dashed border-white/10 rounded-sm">
                                 ...
                                 <p className="text-[10px] font-normal uppercase tracking-[0.4em]">DEFTER GİRİŞİ BULUNAMADI</p>
                              </div>
                           )}
                        </div>
                     </div>
                     ...
                     <div className="flex flex-col pt-6 border-t border-white/5">
                        <h3 className="text-[10px] font-normal text-[#fbbf24] uppercase tracking-[0.4em] mb-4">DERS_BAZLI_DEVAMSIZLIK_ANALİZİ</h3>
                        <div className="min-h-[200px] border border-white/5 bg-black/20 flex flex-col items-center justify-center relative overflow-hidden rounded-sm">
                           ...
                           {studentMissedLessonsSummary.length === 0 ? (
                              <div className="flex flex-col items-center gap-4 z-10 animate-in zoom-in duration-700">
                                 ...
                                 <p className="text-[11px] font-normal text-slate-500 uppercase tracking-[0.4em]">TÜM DERSLERDE %100 KATILIM</p>
                              </div>
                           ) : (
                                 ...
                                 {studentMissedLessonsSummary.map(([lesson, count]) => (
                                    <div key={lesson} className="h-10 bg-[#1e293b] border border-white/5 px-3 flex items-center justify-between hover:bg-slate-800 transition-all rounded-sm">
                                       <div className="flex items-center gap-3 overflow-hidden min-w-0 flex-1">
                                          ...
                                          <span className="text-[11px] font-normal text-white/80 uppercase truncate">{lesson}</span>
                                       </div>
                                       <span className="text-[12px] font-normal text-red-500 shrink-0">{count} DERS</span>
                                    </div>
                                 ))}
                              </div>
                           )}
                  ...
                  <div className="space-y-4 animate-in slide-in-from-bottom-2">
                     ...
                     <div className="bg-[#1e293b] border border-white/5 p-4 rounded-sm">
                        <div className="flex items-center justify-between mb-4 bg-black/20 p-2 rounded-sm border border-white/5">
                           ...
                           <span className="text-[12px] font-normal text-[#fbbf24] uppercase tracking-widest">{attendanceMonth.toLocaleString('tr-TR', { month: 'long', year: 'numeric' })}</span>
                           ...
                           {(() => {
                              ...
                              for (let d = 1; d <= daysInMonth; d++) {
                                 ...
                                 days.push(
                                    ...
                                    >
                                       <span className={`text-[10px] font-normal absolute top-1 left-1 ${hasAbsent ? 'text-red-400' : 'text-slate-500'}`}>{d}</span>
                                       {hasAbsent && (
                                          <div className="mt-3 flex flex-col items-center">
                                             <span className="text-[12px] font-normal text-red-500">{records?.length}</span>
                                             <span className="text-[6px] font-normal text-red-400/70 uppercase">DERS</span>
                                          </div>
                                       )}
                                    </div>
                                 );
                     ...
                     <div className="flex items-center justify-between mt-6 mb-2">
                        <div className="flex items-center gap-2">
                           ...
                           <h3 className="text-[10px] font-normal text-[#3b82f6] uppercase tracking-[0.4em]">
                              {selectedAbsenceDate ? `${selectedAbsenceDate} - DEVAMSIZLIK DETAYI` : 'DETAYLI DEVAMSIZLIK GEÇMİŞİ'}
                           </h3>
                        </div>
                        {selectedAbsenceDate && (
                           <button onClick={() => setSelectedAbsenceDate(null)} className="text-[9px] text-slate-400 hover:text-white uppercase font-normal flex items-center gap-1">
                           ...
                           return (
                              <div key={rec.id} className="bg-[#1e293b] border border-white/5 p-3 flex items-center justify-between hover:bg-slate-800 transition-all rounded-sm group animate-in slide-in-from-left-2">
                                 <div className="flex items-center gap-3 overflow-hidden">
                                    ...
                                    <div className="flex flex-col min-w-0">
                                       <span className="text-[11px] font-normal text-white/90 uppercase truncate group-hover:text-[#3b82f6] transition-colors">{resolvedLessonName}</span>
                                       <span className="text-[8px] font-normal text-slate-500 uppercase flex items-center gap-2">
                                          <span>{rec.date}</span>
                                 ...
                                 <div className="flex flex-col items-end">
                                    <span className="text-[8px] font-normal text-slate-500 uppercase shrink-0">{rec.teacherName.split(' ').pop()}</span>
                                    {rec.status === 'ABSENT' && <span className="text-[7px] font-normal text-red-500 bg-red-500/10 px-1.5 py-0.5 rounded-sm mt-1">YOK</span>}
                                 </div>
                              </div>
                           );
                        ...
                        return (
                           <div key={assign.lessonId} className="bg-[#1e293b] border border-white/5 p-2 flex flex-col gap-1 relative overflow-hidden group hover:bg-[#253447] transition-all">
                              ...
                              <div className="flex justify-between items-center pl-1.5 h-6">
                                 <span className="text-[12px] font-normal text-white/80 uppercase truncate">{lesson?.name}</span>
                                 <span className={`text-[14px] font-normal ${(grade.average || 0) < 50 ? 'text-red-500' : 'text-[#fbbf24]'}`}>{grade.average || '--'}</span>
                              </div>
                              <div className="grid grid-cols-2 gap-1.5 pl-1.5">
                                 <div className="flex flex-col gap-0.5">
                                    <span className="text-[5px] font-normal text-[#3b82f6] uppercase tracking-widest opacity-60">I. DÖNEM</span>
                                    <div className="flex gap-0.5">
                                       {[grade.exam1, grade.exam2, grade.exam3, grade.exam4, grade.oral1].map((val, i) => (
                                          <div key={i} className="flex-1 h-6 border border-white/5 bg-black/20 flex flex-col items-center justify-center">
                                             <span className="text-[8px] font-normal text-white">{val || '-'}</span>
                                 ...
                                 <div className="flex flex-col gap-0.5 border-l border-white/5 pl-1.5">
                                    <span className="text-[5px] font-normal text-[#fbbf24] uppercase tracking-widest opacity-60">II. DÖNEM</span>
                                    <div className="flex gap-0.5">
               ...
               {activeTab === 'KURSLAR' && (
                  <div className="space-y-6 animate-in slide-in-from-bottom-2 pb-12">
                     ...
                     <div className="space-y-2">
                        <span className="text-[9px] font-normal text-[#fbbf24] uppercase tracking-[0.4em] ml-1">AKTİF_KURS_DNA</span>
                              ...
                              courses.filter(k => student.courseIds?.includes(k.id)).map(k => (
                                 ...
                                 >
                                    ...
                                    <div className="ml-2 flex-1 min-w-0 pr-4">
                                       <div className="text-[13px] font-normal text-white uppercase leading-none truncate">{k.name}</div>
                                       <div className="flex items-center gap-2 mt-1.5">
                                          <span className="text-[7px] font-normal text-slate-500 uppercase tracking-widest">{k.teacherName}</span>
                                          <span className="text-[7px] font-normal text-[#fbbf24] uppercase">{k.schedule}</span>
                                       </div>
                                    </div>
                     ...
                     {/* KATALOG */}
                     <div className="space-y-2">
                        <span className="text-[9px] font-normal text-[#3b82f6] uppercase tracking-[0.4em] ml-1">KATALOG_DNA</span>
                                 ...
                                 >
                                    <div className="flex flex-col flex-1 min-w-0 pr-4">
                                       ...
                                       <div className="flex items-center gap-2 mt-1">
                                          ...
                                          <span className="text-[6px] font-normal text-[#fbbf24] uppercase tracking-widest">{k.schedule}</span>
                                       </div>
                                    </div>
                                    <button
               ...
               <div className="fixed inset-0 z-[8500] flex items-center justify-center bg-black/95 backdrop-blur-md px-4">
                  <div className="bg-[#0d141b] border-2 border-[#fbbf24] w-full max-w-md shadow-2xl flex flex-col animate-in zoom-in-95 duration-300 rounded-sm overflow-hidden h-[80vh] bg-grid-hatched">
                     <div className="p-4 border-b border-white/10 flex justify-between items-center bg-[#162431]">
                        <div>
                           <h3 className="text-[14px] font-normal text-white uppercase tracking-tight leading-tight truncate max-w-[250px]">{viewingCourse.name}</h3>
                           <span className="text-[7px] font-normal text-[#fbbf24] uppercase mt-1 block tracking-widest">KATILIMCI LİSTESİ</span>
                        </div>
                        ...
                        {enrolledStudentsForModal.length > 0 ? enrolledStudentsForModal.map(({ student: st, className }) => (
                           <div key={st.id} className="bg-black/40 border border-white/5 p-3 flex items-center justify-between">
                              <div className="flex items-center gap-3">
                                 ...
                                 <span className="text-[9px] font-normal text-white/80 uppercase">{st.name}</span>
                              </div>
                              <span className="text-[8px] font-normal text-[#fbbf24] bg-[#fbbf24]/5 px-2 py-0.5 border border-[#fbbf24]/10">{className}</span>
                           </div>
                        )) : <div className="py-20 text-center opacity-20 text-[10px] uppercase font-normal tracking-widest">Kayıt Bulunmuyor</div>}
                     </div>
                     <div className="p-4 bg-[#162431] border-t border-white/10">
                        <button onClick={() => setViewingStudentsId(null)} className="w-full h-12 bg-white text-black font-normal text-[11px] uppercase tracking-widest active:scale-95 transition-all">KAPAT</button>
                     </div>
                  </div>
               </div>
            )}
      ...
      <div className="space-y-6 animate-slide-up pb-20 overflow-x-hidden">
         ...
         {userRole === UserRole.ADMIN && subscriptionStatus === 'TRIALING' && trialEndsAt && (
            <div className="mx-1 p-3 bg-gradient-to-r from-blue-900/40 to-indigo-900/40 border border-blue-500/30 flex items-center justify-between rounded-sm relative overflow-hidden group">
               ...
               <div className="flex items-center gap-4 z-10">
                  ...
                  <div>
                     <h4 className="text-[11px] font-normal text-white uppercase tracking-widest leading-none">DENEME SÜRESİ AKTİF</h4>
                     <p className="text-[8px] font-normal text-blue-200/60 uppercase mt-1 tracking-widest">SİSTEMİ {Math.ceil((trialEndsAt - Date.now()) / (1000 * 60 * 60 * 24))} GÜN DAHA ÜCRETSİZ KULLANABİLİRSİNİZ</p>
                  </div>
               </div>
               <div className="flex flex-wrap items-center justify-end gap-2 z-10 sm:flex-nowrap">
                  <button
                     ...
                     className="px-4 sm:px-6 py-2 bg-green-600 text-white font-normal text-[9px] uppercase tracking-widest hover:brightness-110 active:scale-95 transition-all shadow-[0_0_20px_rgba(22,163,74,0.3)] whitespace-nowrap"
                  >
                     ŞİMDİ ABONE OL
                  </button>
                  <button
                     onClick={() => setActiveModule(ModuleType.SETTINGS)}
                     className="px-4 sm:px-6 py-2 bg-blue-600/50 border border-blue-500/30 text-white font-normal text-[9px] uppercase tracking-widest hover:bg-blue-600 transition-all whitespace-nowrap"
                  >
                     AYARLAR
                  </button>
               </div>
         ...
         <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3 px-1">
            <div className="bg-[#1e293b]/60 border border-white/10 p-3 flex flex-col justify-between h-28 shadow-lg group">
               <span className="text-[8px] font-normal text-slate-500 uppercase tracking-widest">SİSTEM_KADROSU</span>
               <span className="text-[32px] font-normal text-white leading-none">{teachers.length}</span>
               <span className="text-[7px] font-normal text-green-500 uppercase tracking-widest">DNA_AKTİF</span>
            </div>
            <div className="bg-[#1e293b]/60 border border-white/10 p-3 flex flex-col justify-between h-28 shadow-lg">
               <span className="text-[8px] font-normal text-slate-500 uppercase tracking-widest">ŞUBELER</span>
               <span className="text-[32px] font-normal text-white leading-none">{classes.length}</span>
               <div className="h-0.5 bg-[#3b82f6] w-full shadow-[0_0_10px_#3b82f6]"></div>
            </div>
            <div className="bg-[#1e293b]/60 border border-white/10 p-3 flex flex-col justify-between h-28 shadow-lg">
               <span className="text-[8px] font-normal text-slate-500 uppercase tracking-widest">ÖĞRENCİLER</span>
               <span className="text-[32px] font-normal text-white leading-none">{classes.reduce((acc, c) => acc + (c.students?.length || 0), 0)}</span>
            ...
            <div className="bg-[#1e293b]/60 border border-white/10 p-3 flex flex-col justify-between h-28 shadow-lg group">
               <span className="text-[8px] font-normal text-slate-500 uppercase tracking-widest">CORE_ENGINE</span>
               <i className="fa-solid fa-microchip text-2xl text-[#3b82f6]/40 group-hover:scale-110 group-hover:text-[#3b82f6] transition-all"></i>
               <span className="text-[7px] font-normal text-[#3b82f6] uppercase">STABILITY_v2.5</span>
            </div>
         </div>
         ...
         <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-[#0d141b]/90 border border-[#354a5f]/40 p-5 relative overflow-hidden bg-grid-hatched shadow-2xl rounded-sm">
               <div className="flex items-center justify-between mb-8">
                  <div>
                     <h3 className="text-[13px] font-normal text-white uppercase tracking-[0.4em] leading-none">Z A M A N _ T Ü N E L İ</h3>
                     <p className="text-[7px] font-normal text-slate-500 uppercase mt-2 tracking-widest">GÜNCEL OKUL AKIŞI VE BİLDİRİMLER</p>
                  </div>
                  <button onClick={() => setActiveModule(ModuleType.COMMUNICATION)} className="px-4 py-1.5 bg-[#3b82f6]/10 border border-[#3b82f6]/30 text-[#3b82f6] text-[9px] font-normal uppercase tracking-widest hover:bg-[#3b82f6] hover:text-white transition-all shadow-lg">TÜMÜ</button>
               </div>
                  ...
                  {announcements.length > 0 ? announcements.slice(0, 8).map((item, idx) => (
                     <div key={item.id} className="flex gap-3 relative animate-in slide-in-from-left duration-300">
                        ...
                        <div className="flex-1 bg-black/40 border border-white/5 p-3.5 rounded-sm hover:border-[#3b82f6]/20 transition-all group">
                           <span className="text-[11px] font-normal text-white uppercase tracking-tight group-hover:text-[#3b82f6] transition-colors block mb-1">{item.title}</span>
                           <p className="text-[9px] font-normal text-slate-400 leading-snug italic border-l border-white/10 pl-3">{item.content}</p>
                        </div>
                     </div>
                  )) : (
                     <div className="py-24 text-center opacity-10 flex flex-col items-center">
                        <i className="fa-solid fa-stream text-5xl mb-4"></i>
                        <span className="text-[12px] font-normal uppercase tracking-[0.5em]">AKIŞ_SESSİZ</span>
                     </div>
                  )}
               </div>
            </div>
            ...
            <div className="bg-[#0d141b]/90 border border-red-600/30 p-5 relative overflow-hidden bg-grid-hatched shadow-2xl rounded-sm flex flex-col">
               <div className="flex items-center justify-between mb-6 shrink-0">
                  <div>
                     <h3 className="text-[13px] font-normal text-white uppercase tracking-[0.2em] leading-none">YOKLAMA RADARI</h3>
                     <p className="text-[7px] font-normal text-red-500 uppercase mt-2 tracking-widest">BUGÜNÜN DEVAMSIZLARI ({todaysAbsentees.length})</p>
                  </div>
                  ...
                  {todaysAbsentees.length > 0 ? todaysAbsentees.map((item, idx) => (
                     <div key={idx} className="bg-black/40 border border-white/5 p-3 flex items-center justify-between group hover:border-red-600/40 transition-all rounded-sm">
                        <div className="flex items-center gap-3">
                           ...
                           <div className="flex flex-col">
                              <span className="text-[9px] font-normal text-white/80 uppercase">{item.student.name}</span>
                              <div className="flex items-center gap-2">
                                 <span className="text-[8px] font-normal text-[#fbbf24] bg-[#fbbf24]/10 px-1 border border-[#fbbf24]/20">{item.className}</span>
                                 <span className="text-[7px] font-normal text-slate-500 truncate max-w-[100px]">{item.lessons.slice(0, 2).join(', ')}{item.lessons.length > 2 ? '...' : ''}</span>
                              </div>
                           </div>
                        </div>
                        <div className="flex flex-col items-end">
                           <span className="text-[16px] font-normal text-red-500 leading-none">{item.missedCount}</span>
                           <span className="text-[6px] font-normal text-slate-500 uppercase">DERS</span>
                        </div>
                     </div>
                  )) : (
                     <div className="h-full flex flex-col items-center justify-center opacity-30">
                        <i className="fa-solid fa-clipboard-check text-5xl mb-4 text-green-500"></i>
                        <p className="text-[10px] font-normal uppercase tracking-[0.2em] text-center">BUGÜN DEVAMSIZLIK YOK</p>
                     </div>
                  )}
               </div>
            </div>
